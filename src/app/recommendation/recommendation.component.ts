...
@Component({
  ...
  <div class="dark:bg-gray-700 bg-gray-300 rounded-lg p-4">
    ...
    <a class="rounded-lg bg-white hover:bg-neutral-200 text-black flex justify-between items-center w-full p-4" [href]="recommendation.pdfPath" download><p>{{getFileName()}}</p><img class="w-8" src="assets/pdf-logo.png"/></a>
  </div>
  `
})
